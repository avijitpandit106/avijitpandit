...
export default function Projects() {
  ...
  return (
    <section
      className="bg-gradient-to-b from-gray-900 to-slate-900 flex flex-col justify-center items-center py-10 sm:py-14 md:py-20 lg:py-24 px-4 sm:px-6 md:px-10 lg:px-14"
      id="projects"
    >
      <div className="container mx-auto max-w-7xl">
        <h1
          className={`${itim.className} text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center text-white font-bold pb-10 sm:pb-14`}
        >
          My Projects
        </h1>
      ...
      <div className="mt-10 sm:mt-12">
        <Link
          href="#"
          className="group relative text-blue-200 hover:text-blue-300 rounded-md transition-colors duration-300 ease-in-out text-lg sm:text-xl"
        >
