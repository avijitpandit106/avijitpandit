...
export default function Contact() {
  return (
    <section className="flex flex-col lg:flex-row items-stretch p-6 rounded-lg drop-shadow-[0_35px_35px_rgba(0,0,0,0.25)] max-w-5xl mx-auto">
      {/* Form Section */}
      <div className="bg-white p-8 rounded-l-lg shadow-lg w-full lg:w-1/2 flex flex-col">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-gradient-to-tr from-cyan-600 to-teal-600 rounded-r-lg text-white p-10">
